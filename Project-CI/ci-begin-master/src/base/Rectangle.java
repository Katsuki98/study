...
//        boolean intersectsX = (other.top() >= this.top() && other.top() <= this.bottom()
//                || (other.bottom() >= this.top() && other.bottom() <= this.bottom()));
//        boolean intersectsY = (other.left() >= this.left() && other.left() <= this.right()
//                || (other.right() >= this.left() && other.left() <= this.right()));
        boolean intersectsX = this.left() <= other.right() && other.left() <= this.right();
        boolean intersectsY = this.top() <= other.bottom() && other.top() <= this.bottom();
